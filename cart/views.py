...
def add_cart(request, product_id):
    ...
    if is_cart_item_exist:
        ...
        for items in cart_item:
            all_variation = items.variation.all()
            exist_variation.append(list(all_variation))
            id.append(items.id)
        if product_variation in exist_variation:
            index = exist_variation.index(product_variation)
            id = id[index]
